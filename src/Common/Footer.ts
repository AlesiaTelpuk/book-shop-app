...
export class Footer extends Component {
  constructor(parrent: HTMLElement) {
    ...
    const icon1 = new Component(contacts.root, 'a', ["icon1__a"], null, ["href"], ["https://www.instagram.com/alesia.serg/"]);
    new Component(icon1.root, 'img', ["icons__footer"], null, ["src", "alt"], ["./assets/Icons/Insta.svg", "insta"]);
    const icon2 = new Component(contacts.root, 'a', ["icon2__a"], null, ["href"], ["https://t.me/alesia_serg"]);
    ...
    new Component(account__li.root, 'a', null, "Personal account", ["href"], ["#account"]);
    new Component(account__li.root, 'a', null, "My orders", ["href"], ["#orders"]);
    new Component(account__li.root, 'a', null, "Basket", ["href"], ["#basket"]);
    new Component(account__li.root, 'a', null, "My favorite", ["href"], ["#account"]);
